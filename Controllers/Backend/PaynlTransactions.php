...
class Shopware_Controllers_Backend_PaynlTransactions extends Shopware_Controllers_Backend_Application
{
    ...
    protected $alias = 's_paynlpayment_transactions';
    ...
    protected function getListQuery()
    {
        ...
        $builder->leftJoin('s_paynlpayment_transactions.status', 'status')
                ->leftJoin('s_paynlpayment_transactions.customer', 'customer')
                ->leftJoin('s_paynlpayment_transactions.order', 's_order');
        $builder->addSelect([
            'status',
            'customer',
            's_order'
