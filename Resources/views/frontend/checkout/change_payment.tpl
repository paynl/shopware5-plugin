    ...
    <div class="panel--body is--wide block-group">
        {foreach $sPayments as $payment_mean}
            {if $payment_mean.action == constant("PaynlPayment\PaynlPayment::PLUGIN_NAME")}
                <div class="payment--method paynl-payment-method {if $payment_mean['name'] == 'paynl_10'}paynl-ideal-payment-method {/if} block{if $payment_mean@last} method_last{else} method{/if}">
